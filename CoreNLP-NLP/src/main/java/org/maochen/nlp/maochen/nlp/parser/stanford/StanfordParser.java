package org.maochen.nlp.maochen.nlp.parser.stanford;
...
import org.maochen.nlp.maochen.nlp.datastructure.LangLib;
...
public abstract class StanfordParser implements IParser {
    ...
    protected void load(final String posTaggerModel, final boolean initNER) {
